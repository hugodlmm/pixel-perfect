...
let inputRange = document.querySelector("#opacity");
let buttonleft = document.querySelector("#gg-border-left");
let buttontop = document.querySelector("#gg-border-top");
// =============================================
...
buttonleft.addEventListener("click", () => {
  ...
  activeView = "border-left";
});
buttontop.addEventListener("click", () => {
  resetActive();
  buttontop.classList.add("active");
  activeView = "border-top";
});
...
function initInputs() {
  chrome.storage.local.get("thumbnailProperties", (result) => {
    ...
    if (typeof storedThumbnail !== "undefined") {
      ...
      opacityOverlay = storedThumbnail.opacity;
      activeView = storedThumbnail.view;
      console.log(activeView);
      if (!activeView) activeView = "border-left";
      if (activeView == "border-left") buttonleft.classList.add("active");
      if (activeView == "border-top") buttontop.classList.add("active");
...
async function launchScript() {
  ...
  window.parent.postMessage(
    { type: "find_card", opacity: inputRange.value, view: activeView },
    "*"
  );
